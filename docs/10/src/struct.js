...
const createStruct = (o, existingBase = null, mode = 'seal') => {
    ...
    Object.defineProperty(structObj, kSchema, {
        value: o,
        writable: false,
        configurable: false,
        enumerable: false
    ...
    Object.defineProperty(structObj, kMode, {
        value: mode,
        writable: false,
        configurable: false,
        enumerable: false
...
struct.clone = (target) => {
    owT.o.obj(target);
    return createStruct(target[kSchema], structuredClone(target._), target[kMode]);
};
struct.extends = (target, additionalSchema) => {
    ...
    return createStruct(
        ...
        { ...structuredClone(target._), ...makeBaseObj(additionalSchema) },
        target[kMode]
    );
};
