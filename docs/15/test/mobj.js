...
//                    assertThrow(TypeError, `Expected: '${v.toString()}' like value.\nActual: String`, ()=>o.v = a);
    ...
    describe(`Nest系`, ()=>{
        test(`新規追加不可`, ()=>{
            ...
            o.a.b = {};
            expect(o.a.b.c).toBe(1);
            assertThrow(Error, 'Property "d" is not defined in the structure.', ()=>o.a.b = {d:2});
//            o.a.b = {d:2}; // 生成時に存在しないプロパティ
//    //        expect(o.a.b).not.toHaveProperty('d');
//            expect(o.a.b.d).toBe(2);
        });
        test(`既存削除不可`, ()=>{
            const o = mobj({a:{b:{c:isT.p.int, d:isT.p.str}}});
            expect(o).toBeInstanceOf(Object);
            expect(o).toHaveProperty('a');
            expect(o.a).toHaveProperty('b');
            expect(o.a.b).toHaveProperty('c');
            expect(o.a.b).toHaveProperty('d');
            assertThrow(TypeError, 'Unable to delete property.', ()=>delete o.a.b.d);
            /*
            delete o.a.b.d;
            expect(o).toHaveProperty('a');
            expect(o.a).toHaveProperty('b');
        ...
        test(`上書き。存在しないプロパティ`, ()=>{
            ...
            o.a.b = {d:'a'};
            expect(o.a.b.c).toBe(1);
            expect(o.a.b.d).toBe('a');
            o.a.b = {c:2, d:'b'};
            expect(o.a.b.c).toBe(2);
            expect(o.a.b.d).toBe('b');
            o.a.b = {};
            expect(o.a.b.c).toBe(2);
            expect(o.a.b.d).toBe('b');
            assertThrow(Error, 'Property "z" is not defined in the structure.', ()=>o.a.b = {z:0n});
            assertThrow(Error, 'Property "z" is not defined in the structure.', ()=>o.a.b = {c:3, z:0n});
            expect(o.a.b.c).toBe(2); // 3
            expect(o.a.b).not.toHaveProperty('z');
            /*
            o.a.b = {};
            expect(o.a.b.c).toBe(1);
            assertThrow(Error, 'Property "d" is not defined in the structure.', ()=>o.a.b = {d:2});
...
//            expect(o.a.b.d).toBe(2);
        ...
        test(`上書き。存在するプロパティだが型が違う`, ()=>{
            ...
            expect(o.a.b.c).toBe(0);
            expect(o.a.b.d).toBe('');
            assertThrow(Error, 'Invalid value for property "d"', ()=>o.a.b = {c:1, d:1}); // dの型が違う
        });
        test(`上書き。存在するプロパティだが型が違う。owTで先に例外発生させる。`, ()=>{
            const o = mobj({a:{b:{c:owT.p.int, d:owT.p.str}}});
            expect(o).toBeInstanceOf(Object);
            expect(o).toHaveProperty('a');
            expect(o.a).toHaveProperty('b');
            expect(o.a.b).toHaveProperty('c');
            ...
            expect(o.a.b.d).toBe('');
            // dの型が違う
            assertThrow(Error,`Expected: '${isT.p.str.toString()}' like value.\nActual: Integer`,()=>o.a.b={c:1,d:1});
        });
    });
});
/*
...
describe(`mobj.freeze`, ()=>{
    test(`Nest系`, ()=>{
        const o = mobj.freeze({a:{b:{c:isT.p.int}}});
        expect(o).toBeInstanceOf(Object);
        expect(o).toHaveProperty('a');
        expect(o.a).toHaveProperty('b');
        expect(o.a.b).toHaveProperty('c');
        expect(o.a.b.c).toBe(0);
        //o.a.b.c = 1;
        assertThrow(Error, 'Cannot assign to a frozen object.', ()=>o.a.b.c = 1);
        //expect(o.a.b.c).toBe(1);
        expect(o.a.b.c).toBe(0);
        //o.a.b = {};
        assertThrow(Error, 'Cannot assign to a frozen object.', ()=>o.a.b = {});
//        expect(o.a.b.c).toBe(1);
        expect(o.a.b.c).toBe(0);
        // 生成時に存在しないプロパティを代入する
        assertThrow(Error, 'Cannot assign to a frozen object.', ()=>o.a.b = {d:2});
        expect(o.a.b).not.toHaveProperty('d');
//        o.a.b = {d:2}; // 生成時に存在しないプロパティ
//        expect(o.a.b).not.toHaveProperty('d');
//        expect(o.a.b.d).toBe(2);
